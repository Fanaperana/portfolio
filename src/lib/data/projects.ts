...
export const PROFILE = {
  ...
  // Short resume headline — shown in hero and SEO.
  ...
  hobbies: [
    ...
    "Writing parsers & expression-oriented languages",
    "Infinite-canvas UIs and node editors",
    "Making terminals beautiful",
    "Research-grade notes in LaTeX",
    "Cinema-quality motion design in After Effects",
  ],
  // Expertise groupings — used by About.svelte.
  expertise: [
    { label: "Rust", level: 5, note: "CLIs, TUIs, WASM, numerics, parsers" },
    { label: "TypeScript", level: 5, note: "Svelte 5, React, Vue, node" },
    {
      label: "WebAssembly",
      level: 4,
      note: "wasm-bindgen, wasm-pack, web glue",
    },
    {
      label: "Tauri / desktop",
      level: 4,
      note: "Shipping Rust-backed desktop apps",
    },
    {
      label: "Agentic AI",
      level: 4,
      note: "Planners, tools loop, eval harnesses",
    },
    { label: "Systems / Linux", level: 3, note: "Wayland, kernels, kiosks" },
  ],
} as const;
...
export const PROJECTS: Project[] = [
  // ── flagship toolchain / infra ──
  {
    slug: "semtree",
    title: "semtree",
    description:
      "Universal Incremental Language Infrastructure — faster than Tree-sitter, with built-in formatter, linter, refactoring, and IDE support. Pure Rust.",
    language: "Rust",
    tags: ["rust", "parser", "tree-sitter", "ide", "incremental"],
    stars: 0,
    pushed_at: "2026-07-07T14:36:30Z",
    url: "https://github.com/Fanaperana/semtree",
    highlight: true,
    accent: "rose",
    glyph: "⌬",
  },
  {
    slug: "adaptive-codegraph",
    title: "adaptive-codegraph",
    description:
      "Language-agnostic code graph indexer, search engine, and MCP server — add a language with .toml + .scm files. Rust.",
    language: "Rust",
    tags: ["rust", "code-graph", "mcp", "search", "tree-sitter"],
    stars: 4,
    pushed_at: "2026-05-19T20:46:11Z",
    url: "https://github.com/Fanaperana/adaptive-codegraph",
    highlight: true,
    accent: "cyan",
    glyph: "⬡",
  },
  {
    ...
    title: "codegraph",
    description:
      "Codebase graph analysis CLI with hybrid retrieval (Neo4j graph + vector similarity). Multi-language parsing via tree-sitter.",
    language: "Rust",
    tags: ["rust", "graph", "neo4j", "vector", "cli"],
    stars: 0,
    pushed_at: "2026-04-26T03:24:49Z",
    url: "https://github.com/Fanaperana/codegraph",
    accent: "indigo",
    glyph: "⊛",
  },
  {
  ...
  },
  {
    ...
    title: "cinecode-docs",
    description:
      "Documentation for CineCode — a pure-Rust cinematic engine for programming documentaries. Diátaxis + Fumadocs.",
    language: "MDX",
    tags: ["rust", "docs", "cinematic", "fumadocs"],
    stars: 1,
    pushed_at: "2026-06-29T02:50:49Z",
    url: "https://github.com/Fanaperana/cinecode-docs",
    highlight: true,
    accent: "amber",
    glyph: "▶",
  },
  ...
  },
  {
    ...
    stars: 0,
    pushed_at: "2026-04-19T01:52:21Z",
  ...
  },
  {
    ...
    title: "pskey",
    description:
      "Tiny transparent Tauri widget password manager — libsodium, Argon2id, challenge-response PIN. Minimal attack surface.",
    language: "TypeScript",
    tags: ["tauri", "rust", "security", "password-manager"],
    stars: 3,
    pushed_at: "2026-06-20T00:26:58Z",
    url: "https://github.com/Fanaperana/pskey",
    highlight: true,
    accent: "emerald",
    glyph: "⚷",
  },
  ...
  },
  {
    ...
    stars: 3,
    pushed_at: "2026-04-22T23:41:30Z",
  ...
  },
  {
    ...
    title: "quantrs",
    description:
      "Quantitative experiments in Rust — fast numerics and market tooling.",
    language: "Rust",
